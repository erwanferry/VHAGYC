<x-app-layout>
    ...
    <header>
        ...
        <div class="hidden fixed top-0 right-0 px-6 py-4 sm:block">
            @auth
                <a href="{{ url('/navigation') }}" class="text-sm text-gray-700 dark:text-gray-500 underline">Dashboard</a>
            @else
                <div class="selector">   
    ...
    <body>
        <div class="welcome">
        <img src="picture/voiliers.jpg" width="100%" height="100%" alt = "image composé de plusieur voiliers" >
        <div class="overlay"> 
